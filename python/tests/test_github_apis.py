...
class GitHubApiTests(unittest.TestCase):
    ...
    def test_list_commits_for(self):
        ...
        commits = github_apis.list_commits_for(
            pr_number, self._github_owner, self._github_repo, self._github_token, nmax=1)
    ...
    def test_list_change_files_from(self):
        ...
        commit_date, commit_message, files = github_apis.list_change_files_from(
            ref, self._github_owner, self._github_repo, self._github_token)
    ...
    def test_list_change_files_between(self):
        ...
        commit_date, commit_message, files = github_apis.list_change_files_between(
            base, head, self._github_owner, self._github_repo, self._github_token)
    ...
    def test_list_file_commits_with_period_specified(self):
        commits = github_apis.list_repo_commits(self._github_owner, self._github_repo, self._github_token,
                                                path='README.md', since='2011-04-1T05:31:29Z',
                                                until='2012-04-01T05:31:29Z')
    ...
    def test_list_workflow_jobs(self):
        ...
        self.assertEqual(len(runs), 1)
        run_id = runs[0][0]
        jobs = github_apis.list_workflow_jobs(
            run_id, self._github_owner, self._github_repo, self._github_token, nmax=1)
